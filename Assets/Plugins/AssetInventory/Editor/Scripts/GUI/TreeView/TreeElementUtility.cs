...
namespace AssetInventory
{
    ...
    {
        private sealed class TestElement : TreeElement
        {
        ...
        public static void TestTreeToListWorks()
        {
            ...
            {
                Assert.AreEqual(namesInCorrectOrder[i], result[i].TreeName);
            }
        ...
        public static void TestListToTreeWorks()
        {
            ...
            // Assert
            Assert.AreEqual("root", root.TreeName);
            Assert.AreEqual(3, root.Children.Count);
            Assert.AreEqual("C", root.Children[2].TreeName);
            Assert.AreEqual("Bchildchild", root.Children[1].Children[0].Children[0].TreeName);
        }
